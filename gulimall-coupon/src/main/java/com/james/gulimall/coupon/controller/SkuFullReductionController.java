...
public class SkuFullReductionController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("mapper.coupon:skufullreduction:list")
    ...
    //@RequiresPermissions("mapper.coupon:skufullreduction:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("mapper.coupon:skufullreduction:save")
    ...
    //@RequiresPermissions("mapper.coupon:skufullreduction:update")
    ...
    //@RequiresPermissions("mapper.coupon:skufullreduction:delete")
